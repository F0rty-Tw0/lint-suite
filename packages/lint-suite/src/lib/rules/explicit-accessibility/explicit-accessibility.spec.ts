...
const inClass = (render: Render, abstract = false): Render => {
...
ruleTester.run('local/explicit-accessibility', rule, {
  ...
  invalid: [
    ...
    },
    {
      ...
      options: [{ defaultAccessibility: 'private' }],
          ...
          suggestions: [
            {
              ...
              output: `class A { private constructor(readonly dep: string) {} }`
            },
            {
              messageId: 'setAccessibility',
              data: { accessibility: 'protected' },
              output: `class A { protected constructor(readonly dep: string) {} }`
            }
          ]
        },
        {
          ...
          suggestions: [
            {
              ...
              output: `class A { constructor(public readonly dep: string) {} }`
            },
            {
              messageId: 'setAccessibility',
              data: { accessibility: 'protected' },
              output: `class A { constructor(protected readonly dep: string) {} }`
            }
          ]
        }
      ]
