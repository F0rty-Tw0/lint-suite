...
import type {
  ClassAttributeHost,
  ClassMatcher
} from '@lint-suite/rule-internals/common/class-usage.type.ts';
import {
  createFileCache,
  readCached
} from '@lint-suite/rule-internals/file-cache.ts';
import { classMatcher } from '@lint-suite/rule-internals/selector-classes.ts';
import { classExpressionUsage } from '@lint-suite/rule-internals/utils/class-expression-literals.util.ts';
import {
  isClassExpression,
  templateClasses
} from '@lint-suite/rule-internals/utils/template-classes.util.ts';
