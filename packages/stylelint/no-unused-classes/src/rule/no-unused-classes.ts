import type { ClassMatcher } from '@lint-suite/rule-internals/common/class-usage.type.ts';
import { selectorTemplateClasses } from '@lint-suite/rule-internals/selector-classes.ts';
...
const meta: RuleMeta = {
  url: 'https://github.com/F0rty-Tw0/lint-suite/tree/master/packages/stylelint/no-unused-classes#readme'
};
