...
const rule = plugin.rules?.['no-call-in-condition'];
...
ruleTester.run('no-call-in-condition/no-call-in-condition', rule, {
  valid,
  invalid
});
...
typedTester.run('no-call-in-condition/no-call-in-condition', rule, {
  valid: typedValid,
