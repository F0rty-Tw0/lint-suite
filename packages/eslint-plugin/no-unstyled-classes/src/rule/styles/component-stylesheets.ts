...
import { componentMetadata } from '@lint-suite/rule-internals/component-metadata.ts';
import type { ComponentDescriptor } from '@lint-suite/rule-internals/common/class-usage.type.ts';
